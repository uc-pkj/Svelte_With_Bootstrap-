...
<main>
	<div class="container my-4 d-flex align-items-center flex-column">
		<div class="row d-flex justify-content-around align-items-center border border-secondary border-4 rounded m-1 p-1 w-75">
			<div class="col  border border-2 border-danger rounded text-center text-uppercase p-1 m-1 d-flex justify-content-center flex-column "> 
		...
		<div class="d-flex flex-row justify-content-around w-50 m-2">
			<h6 class="mb-3">(Attempted + Correct)  : <span class=" border border-dark border-2 d-inline-block bg-success" style=" width:30px;height:20px"></span></h6>
			<h6 class="mb-3">(Attempted + InCorrect)  : <span class=" border border-dark border-2 d-inline-block bg-danger" style=" width:30px;height:20px"></span></h6>
			<h6 class="mb-3">(Correct Answers)  : <span class=" border border-dark border-2 d-inline-block bg-info" style=" width:30px;height:20px"></span></h6>
		</div>
					...
					<!-- for questions  -->
						<div class="col-8  ">
							...
							<p id="topques" class="fw-bold">
								<a  class="text-decoration-none text-dark d-block text-nowrap overflow-hidden text-truncate" href={`Review/${i}`} on:click={reviewPage}>Q{i + 1}.{JSON.parse(item.content_text).question}</a>
							</p>
						</div>
							...
							<div class="row ">
								<div class="col d-flex p-0">
									{#each option as optionData, j}
										<div
											class="{`${actualCorrectArray[i] == j}`} border col w-25 text-center align-middle "
...
<div class="d-flex justify-content-center align-items-center">
	<a href="/">
		<button class=" border rounded bg-primary text-light border-dark border-2 p-2 "><h5 class="m-0">Restart</h5></button>
	</a>
</div>
